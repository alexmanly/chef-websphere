...
default[:base_was][:was][:jdbc][:my_jdbc][:driverPath] = node[:base_was][:was][:install_dir] + "/oracle/lib/ojdbc6.jar"
default[:base_was][:was][:jdbc][:my_jdbc][:dsname] = "DefaultDataSource"
default[:base_was][:was][:jdbc][:my_jdbc][:dsjndiname] = "jndi_my_ds"
default[:base_was][:was][:jdbc][:my_jdbc][:databaseURL] = "jdbc:oracle:thin:@//10.0.0.80:1521/DB1"
default[:base_was][:was][:jdbc][:my_jdbc][:cfname] = ""
default[:base_was][:was][:jdbc][:my_jdbc][:databasePasswordAlias] = "demo_user"
default[:base_was][:was][:jdbc][:my_jdbc][:databaseUserId] = "demo"
default[:base_was][:was][:jdbc][:my_jdbc][:databasePassword] = "demo"
default[:base_was][:was][:jdbc][:my_jdbc][:databaseDescription] = "demo oracle database"
default[:base_was][:was][:jdbc][:my_jdbc][:agedTimeout] = "0"
default[:base_was][:was][:jdbc][:my_jdbc][:connectionTimeout] = "1900"
default[:base_was][:was][:jdbc][:my_jdbc][:maxConnections] = "50"
default[:base_was][:was][:jdbc][:my_jdbc][:minConnections] = "5"
default[:base_was][:was][:jdbc][:my_jdbc][:purgePolicy] = "EntirePool"
default[:base_was][:was][:jdbc][:my_jdbc][:dsReapTime] = "180"
default[:base_was][:was][:jdbc][:my_jdbc][:dsUnusedTimeout] = "1800"
default[:base_was][:was][:jdbc][:my_jdbc][:stmentCacheSize] = "10"
default[:base_was][:was][:jdbc][:my_jdbc][:jdbcj2eeAttr] = ""
default[:base_was][:was][:jdbc][:my_jdbc][:jdbcimplclass] = ""
default[:base_was][:was][:jdbc][:my_jdbc][:jdbcdesc] = ""
default[:base_was][:was][:jdbc][:my_jdbc][:dsHelper] = ""
default[:base_was][:was][:jdbc][:my_jdbc][:dsj2eeAttr] = ""
default[:base_was][:was][:jdbc][:my_jdbc][:stuckTime] = "0"
default[:base_was][:was][:jdbc][:my_jdbc][:stuckTimerTime] = "0"
default[:base_was][:was][:jdbc][:my_jdbc][:stuckThreshold] = "0"
